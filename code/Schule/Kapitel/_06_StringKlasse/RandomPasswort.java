...
public class RandomPasswort {
    public static void main(String[] args) {
        ...
        if (setSafety.equals("y")){
            specialCharAmount = passwortLength/3;
        }
        else {
            specialCharAmount = 0;
        }
        ...
        for (int i=0; i<passwortLength; i++){
            ...
            if (i>=passwortLength-specialCharAmount){
                passwort += specialChars[randCharIndex];
            }
            else {
                passwort += letterChars[randLetterIndex];
            }
        }
